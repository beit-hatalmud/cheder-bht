...
function showPage(name) {
  ...
  if (name === 'cameras' && typeof renderCameras === 'function') renderCameras();
...
function filterByPermissions(){
  const permissions = {
    ...
    'lessonsKlein': ['lessonsKlein','lessons','behavior','all'],
    'tasks': ['tasks','all'],
    'projects': ['projects','tasks','all'],
    'formsMgmt': ['formsMgmt','all'],
    'cameras': ['cameras','all'],
    'staff': ['staff','settings','all'],

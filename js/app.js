...
const PAGES = ['login','home','students','behavior','reading','writing','lessonsKlein','forms','functioning','tests','medications','classview','attendance','calendar','meetings','conversations','settings','reports','feedback'];

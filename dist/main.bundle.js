// === main.bundle.js — built 2026-06-01T07:06:17.362Z ===
// Source: 149 behavior packs concatenated in numeric order.
...
} catch (e) { (console && console.error) ? console.error('[behavior-pack-140.js] init failed:', (e && e.message) || e) : null; }
...
} catch (e) { (console && console.error) ? console.error('[behavior-pack-142.js] init failed:', (e && e.message) || e) : null; }
// ─── behavior-pack-143.js ─────────────────────────────────────────────
try {
...
} catch (e) { (console && console.error) ? console.error('[behavior-pack-151.js] init failed:', (e && e.message) || e) : null; }